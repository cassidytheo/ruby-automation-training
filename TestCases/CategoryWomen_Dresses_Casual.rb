...
class CategoryWomen_Dresses_Casual < Test::Unit::TestCase
  ...
  def test_women_dresses_casual
    ...
    puts "Continuing to open Casual subcategory"
    
    #click on  Casual subcategory (specifically the image)
    @driver.find_element(:xpath, "//img[@src='http://automationpractice.com/img/c/9-medium_default.jpg']").click
    @driver.find_element(:class, 'content_scene_cat_bg').size() != 0
    puts "Open Casual subcategory successful"
  end
