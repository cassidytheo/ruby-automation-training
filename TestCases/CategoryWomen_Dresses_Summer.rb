...
class CategoryWomen_Dresses_Summer < Test::Unit::TestCase
  ...
  puts "Continuing to open Summer subcategory"
  
  #click on  Evening subcategory (specifically the image)
  @driver.find_element(:xpath, "//img[@src='http://automationpractice.com/img/c/11-medium_default.jpg']").click
  @driver.find_element(:class, 'content_scene_cat_bg').size() != 0
  puts "Open Summer subcategory successful"
  end
