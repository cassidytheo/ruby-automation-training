...
class CategoryWomen_Tops_Blouses < Test::Unit::TestCase
  ...
  def test_women_tops_blouses
    ...
    puts "Continuing to open Blouses subcategory"
    
    #click on Blouses subcategory
    @driver.find_element(:xpath, "//img[@src='http://automationpractice.com/img/c/7-medium_default.jpg']").click
    @driver.find_element(:class, 'content_scene_cat_bg').size() != 0
    puts "Open Blouses subcategory successful"
  end
